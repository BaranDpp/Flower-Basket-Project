...
namespace FlowerBasketProject.Controllers
{
    ...
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SenderName,Content,Timestamp,IsRead,UserId")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SenderName,Content,Timestamp,IsRead,UserId")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
