...
namespace FlowerBasketProject.Controllers
{
    ...
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,Timestamp,IsRead,UserId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,Timestamp,IsRead,UserId")] Notification notification)
        {
